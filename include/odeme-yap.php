...
if (!empty($_SESSION['uyeID'])) {
	...
	if ($uyebilgisi!=false) {
					...
					$siparisurunEkle=$VT->SorguCalistir("INSERT INTO siparisurunler","SET uyeID=?, siparisID=?, urunID=?, uruntutar=?, adet=?, kdvdurum=?, kdvoran=?, toplamtutar=?, tarih=?",array($uyebilgisi[0]["ID"],$siparisID,$urunbilgisi[0]["ID"],number_format($fiyat,2,".",""),$bilgi["adet"],1,$urunbilgisi[0]["kdvoran"],number_format($toplamFiyat,2,".",""),date("Y-m-d")));
