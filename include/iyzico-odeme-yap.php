...
$priceTutar=($priceTutar+number_format($toplamFiyat,2,".",""));
                                ...
                                $kdvlifiyat=$toplamtutar; // 100
                                $kdvsizfiyat=($toplamtutar/$oran);/*kdvsiz hali 92,59 */
                                $kdvtutari=($toplamtutar-$kdvsizfiyat);/*KDV Fiyatı 7,41 */
...
$request->setCallbackUrl("https://calismalar.baysarbilisim.com/kk-odeme-sonuc");
