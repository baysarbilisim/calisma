                           ...
                           if($varyasyonlar!=false){ ?>
                            ...
                            switch ($toplamvaryasyonSayisi) {
                                case 1:
                                    ...
                                    <td>
                                        <input type="text" class="form-control" placeholder="Stok" name="stok[]" value="<?=$varyasyonStoklari[0]["stok"]?>">
                                        <input type="hidden" class="form-control" name="stokID[]" value="<?=$varyasyonStoklari[0]["ID"]?>">
                                    </td>
                                </tr>
                         <?php           }
                                    }
