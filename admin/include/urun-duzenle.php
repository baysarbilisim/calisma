       ...
       <div class="content-wrapper">
           ...
           <section class="content">
               <div class="container-fluid">
                   ...
                   if($_POST)
                   {
                       if(!empty($_POST["kategori"]) && !empty($_POST["baslik"]) && !empty($_POST["anahtar"]) && !empty($_POST["description"]) && !empty($_POST["sirano"]) && !empty($_POST["urunkodu"]) && !empty($_POST["fiyat"]) && !empty($_POST["kdvoran"]))
                       {
                           ...
                           if(!empty($_FILES["resim"]["name"]))
                           {
                               ...
                               if($indirimlifiyat!=false)
                               {
                                   ...
                                   $guncelle=$VT->SorguCalistir("UPDATE urunler","SET baslik=?, seflink=?, kategori=?, metin=?, urunkodu=?, anahtar=?, description=?, fiyat=?, kurus=?, indirimlifiyat=?, kdvoran=?, kdvdurum=?, sirano=?, tarih=? WHERE ID=?",array($baslik,$seflink,$kategori,$metin,$urunkodu,$anahtar,$description,$fiyat,$kurus,null,$kdvoran,1,$sirano,date("Y-m-d"),$urunBilgisi[0]["ID"]),1);
                               }
                           }
                                   ...
                                   <div class="row">
                                       ...
                                       <div class="col-md-12">
                                           <div class="form-group">
                                               ...
                                               <textarea class="textarea" placeholder="Açıklama alanıdır." name="metin" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?=stripslashes($urunBilgisi[0]["metin"])?></textarea>
                                           </div>
                                       </div>
                                       <div class="col-md-12">
                                           <div class="form-group">
